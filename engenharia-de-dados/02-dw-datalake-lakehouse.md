...
**Estado do ecossistema (2026):** Iceberg consolidou-se como a escolha padrão para lakehouses novos e abertos, com adoção ampla em catálogos e engines. O spec v3, ratificado em 2025, trouxe deletion vectors, tipo variant para semiestruturado, row lineage e tipos geoespaciais. Delta Lake, originado no Databricks, é maduro e tem o UniForm, que expõe tabelas Delta como se fossem Iceberg para leitores externos. Hudi mantém vantagem específica em cargas de upsert de altíssima frequência, com um Merge-on-Read que grava apenas colunas alteradas, reduzindo write amplification. A tendência é de **convergência**: os três formatos vêm adotando as ideias uns dos outros, e a discussão importante está migrando de "qual formato" para "qual catálogo" — porque é o catálogo que gerencia o commit, o controle de acesso e a interoperabilidade entre engines.
...
*Resposta modelo:* Em 2026, para um lakehouse novo e aberto, Iceberg é a escolha padrão — tem a maior neutralidade de fornecedor, suporte amplo de engines e catálogos, e o REST Catalog padronizou a interface, o que reduz lock-in. O spec v3 trouxe deletion vectors, tipo variant, row lineage e tipos geoespaciais.

Delta faz sentido quando a empresa já está no ecossistema Databricks: a integração é mais profunda e o UniForm permite que leitores externos consumam a tabela como Iceberg. Hudi mantém vantagem específica em upsert de altíssima frequência, porque seu Merge-on-Read grava apenas as colunas alteradas em vez de a linha inteira, reduzindo write amplification.
